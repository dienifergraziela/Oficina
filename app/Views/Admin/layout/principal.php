...
<head>
    ...
    <!-- esta section redenrizara os estilos especificos da view que estender este layout -->
...
<body>
      ...
      <div class="col-md-12 p-0 m-0">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="index.html"><img src="images/logo.png" alt="logo" style="height: 7vh; width: 5vw"/></a>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/ordens">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <!-- esta section redenrizara os conteudos especificos da view que estender este layout -->
    ...
    <!-- esta section redenrizara os scripts especificos da view que estender este layout -->
